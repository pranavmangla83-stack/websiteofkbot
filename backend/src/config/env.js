...
export const env = {
  ...
  sentryFrontendDsn: envValue("SENTRY_FRONTEND_DSN"),
  clarityProjectId: envValue("CLARITY_PROJECT_ID"),
...
const envKeyNames = {
  ...
  sentryFrontendDsn: "SENTRY_FRONTEND_DSN",
  ...
  razorpayProPlanId: "RAZORPAY_PRO_PLAN_ID",
